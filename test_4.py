...
from langchain.agents import initialize_agent, Tool, OpenAIFunctionsAgent, AgentExecutor
...
system_message = SystemMessage(
    ...
    content="""
    Your Name is LexU and you are an AI Legal Assistant expert in Ghana , you use all tools available at your disposition to help 
    the user. You can provide legal advice when necessary. Maintain a friendly conversation with the user , and answer truthfully and in an honest manner to the questions asked.
    Your responses should be clear and concise, in a way that would make the user understand. 
    Ask follow up questions if necessary .
    Remember your scope is limited to Ghana
...
agent_exec = AgentExecutor(tools=tools, llm=llm, agent=agent, memory=memory, verbose=True)
